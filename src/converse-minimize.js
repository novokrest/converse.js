    ...
    converse.plugins.add('converse-minimize', {
        ...
        initialize: function () {
            ...
            _converse.MinimizedChatBoxView = Backbone.View.extend({
                ...
                initialize: function () {
                    console.log('DEV: converse-minimize: initialize()');
                ...
                clearUnreadMessagesCounter: function () {
                    console.log('DEV: converse-minimize: clearUnreadMessagesCounter()-1:', this.model.get('num_unread'));
                    this.render();
                },

                updateUnreadMessagesCounter: function () {
                    console.log('DEV: converse-minimize: updateNewMessageIndicators()-1:', this.model.get('num_unread'));
                    this.render();
                },

                close: function (ev) {
                    console.log('DEV: converse-minimize: close()');
                    if (ev && ev.preventDefault) { ev.preventDefault(); }
                    this.remove();
                ...
                restore: _.debounce(function (ev) {
                    console.log('DEV: converse-minimize: restore()');
                    if (ev && ev.preventDefault) { ev.preventDefault(); }
                    this.model.off('add', null, this);
                    this.remove();
                    this.model.maximize();
                }, 200, {'leading': true})
            });
